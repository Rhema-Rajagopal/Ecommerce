...
const AddProduct = () => {
  ...
  const changeHandler = (e) => {
    setProductDetailes({ ...productDetailes, [e.target.name]: e.target.value });
  };
    ...
    <div className="add-product">
      ...
      <div className="addproduct-price">
        <div className="addproduct-itemfield">
          <p> Price</p>
          <input
            value={productDetailes.old_price}
            onChange={changeHandler}
            type="text"
            name="old_price"
            placeholder="Type here"
        ...
        <div className="addproduct-itemfield">
          <p>Offer Price</p>
          <input
            value={productDetailes.new_price}
            onChange={changeHandler}
            type="text"
            name="new_price"
            placeholder="Type here"
      ...
      <div className="addproduct-itemfield">
        ...
        <select
          value={productDetailes.category}
          onChange={changeHandler}
          name="category"
